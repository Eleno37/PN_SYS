<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="frm_customer_forecast.aspx.vb" Inherits="PN_SYSTEM.frm_customer_forecast" %>
                                ...
                                <div class="card-box table-responsive">
                                    <asp:GridView ID="gv_detail" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered" AllowSorting="True">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Month" ItemStyle-Width="150" Visible="false">
                                                <asp:ItemTemplate>
                                                    <asp:TextBox ID="lblmonth" runat="server" Text='<%#Eval("month") %>' Width="60px" />
                                                </asp:ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Update By" ItemStyle-Width="150" Visible="false">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("record_date") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
