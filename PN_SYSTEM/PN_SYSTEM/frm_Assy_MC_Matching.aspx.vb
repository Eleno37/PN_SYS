Public Class frm_Assy_MC_Matching
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
    End Sub
    Private Sub load_grid_detail(ByVal TopLv_assymc As String, num_row_assymc As Integer)
        If TopLv_assymc <> "" Then
            itemtable = mdSQLCommand.load_assy_mc(TopLv_assymc, num_row_assymc)
        Else
            itemtable = mdSQLCommand.load_assy_mc("", num_row_assymc)
        End If
