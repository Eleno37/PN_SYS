Public Class frm_lose_time
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
    End Sub
    Private Sub load_grid_detail(ByVal TopLv_losttime As String, num_row_losttime As Integer)
        If TopLv_losttime <> "" Then
            itemtable = mdSQLCommand.load_losttime(TopLv_losttime, num_row_losttime)
        Else
            itemtable = mdSQLCommand.load_losttime("", num_row_losttime)
        End If
