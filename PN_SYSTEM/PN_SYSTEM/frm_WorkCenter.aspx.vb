Public Class frm_WorkCenter
    ...
    Private Sub load_grid_detail(ByVal TopLv_workcenter As String, num_row_workcenter As Integer)
        If TopLv_workcenter <> "" Then
            itemtable = mdSQLCommand.load_workcenter(TopLv_workcenter, num_row_workcenter)
        Else
            itemtable = mdSQLCommand.load_workcenter("", num_row_workcenter)
        End If
