<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebForm2.aspx.vb" Inherits="PN_SYSTEM.WebForm2" %>
...
<head runat="server">
    <title></title>
    <link href="asset_login/login_css.css" rel="stylesheet" />
    <script src="asset_login/login_js.js"></script>
</head>
<body>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <asp:GridView ID="gv_detail" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Name" ItemStyle-Width="150" Visible="false">
                                                <asp:ItemTemplate>
                                                    <%--<asp:Label ID="lblfile_name" runat="server" Text='<%#Eval("file_import") %>'></asp:Label>--%>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Name" ItemStyle-Width="150">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblName" runat="server" Text='<%# Eval("file_import") %>'></asp:Label>
